defmodule CodePuppyControl.TUI.Renderer do
  ...
  defp handle_stream_event(%Event.ToolCallStart{index: idx, name: name}, state) do
    # Idempotent: if a spinner already exists for this index (duplicate
    # ToolCallStart from a provider ToolCallEnd that leaked through),
    # skip creating a second spinner and don't reprint the banner.
    # This prevents spinner ref overwrites and unbalanced spinner state.
