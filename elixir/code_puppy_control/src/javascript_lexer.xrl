%%%-----------------------------------------------------------------------------
%%% @doc JavaScript Lexer for CodePuppyControl
%%%
%%% This is a Leex-generated lexer for tokenizing JavaScript source code.
%%% It supports ES6+ features including:
%%%   - Arrow functions (=>)
%%%   - Template literals (`...`)
%%%   - Classes and modules (import/export)
%%%   - Async/await
%%%   - Destructuring syntax basics
%%%
%%% Generated module: :javascript_lexer
%%%-----------------------------------------------------------------------------]
