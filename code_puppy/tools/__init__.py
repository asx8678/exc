# Browser tools removed in djs.2 (DROP-V1). See docs/triage/djs2-deletion-manifest.md
...
# Scheduler tools (stubbed — Python scheduler migrated to Elixir Oban backend)
...
TOOL_REGISTRY = {
    ...
    # Scheduler Tools (stubbed — migrated to Elixir Oban backend)
...
REMOVED_LEGACY_TOOLS: set[str] = {
    # Browser tools removed in djs.2 (DROP-V1)
    "browser_initialize",
    "browser_close",
    "browser_status",
    "browser_new_page",
