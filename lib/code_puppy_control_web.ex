defmodule CodePuppyControlWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      ...
      alias CodePuppyControlWeb.Router.Helpers, as: Routes
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: CodePuppyControlWeb.Router,
        statics: CodePuppyControlWeb.static_paths()
    end
  end
